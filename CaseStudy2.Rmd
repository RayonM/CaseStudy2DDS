...
# classifications = knn(train[,c(36,35,34,33,30,25,20,2,7)],test[,c(36,35,34,33,30,25,20,2,7)],train$Attrition, prob = TRUE, k = 5)
# table(test$Attrition,classifications)
# confusionMatrix(table(test$Attrition,classifications))



# classifications = knn(train[,c(2,7,16,20,22,29,31,33,34,36)],test[,c(2,7,16,20,22,29,31,33,34,36)],train$Attrition, prob = TRUE, k = 5)
# table(test$Attrition,classifications)
# confusionMatrix(table(test$Attrition,classifications))
...
classifications = knn(train[,c("JobInvolvement","WorkLifeBalance","Age",  "JobLevel")],test[,c("JobInvolvement","WorkLifeBalance","Age",  "JobLevel")],train$Attrition, prob = TRUE, k = 5)
table(test$Attrition,classifications)
confusionMatrix(table(test$Attrition,classifications))
