...
for(seed in 1:100)
{
  ...
  modelAttritionYorN = naiveBayes(Train[,c("JobInvolvement", "JobLevel", "OverTime", "WorkLifeBalance")],factor(Train$Attrition, labels=c("No", "Yes")))
  CM = confusionMatrix(table(factor(Test$Attrition, labels = c("No", "Yes")), predict(modelAttritionYorN,Test[,c("JobInvolvement", "JobLevel", "OverTime", "WorkLifeBalance")])))
