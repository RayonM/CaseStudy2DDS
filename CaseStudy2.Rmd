...
#Overtime is another variable - Cannot work for KNN as it requires numberic values
...
classifications = knn(train[,c(36,35,34,33,30,25,20)],test[,c(36,35,34,33,30,25,20)],train$Attrition, prob = TRUE, k = 5)
...
model = naiveBayes(train[,c(36,35,34,33,30,25,20)],train$Attrition)
table(predict(model,test[,c(36,35,34,33,30,25,20)]),test$Attrition)
confusionMatrix(table(predict(model,test[,c(36,35,34,33,30,25,20)]),test$Attrition))
