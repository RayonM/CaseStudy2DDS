...
employeeDataZ = data.frame(AgeZ = scale(employeeData$Age), DistanceFromHomeZ = scale(employeeData$DistanceFromHome), JoblevelZ = scale(employeeData$JobLevel), MonthlyIncomeZ = scale(employeeData$MonthlyIncome), NumCompaniesWoredZ = scale(employeeData$NumCompaniesWorked), StockOptionLevelZ = scale(employeeData$StockOptionLevel), TrainingTimesLastYearZ = scale(employeeData$TrainingTimesLastYear), YearsAtCompanyZ = scale(employeeData$YearsAtCompany), YearsInCurrentRoleZ = scale(employeeData$YearsInCurrentRole), YearsWithCurrentManager = scale(employeeData$YearsWithCurrManager), Attrition = employeeData$Attrition)
...
model1 = naiveBayes(employeeData$Attrition~., data = employeeData)

AB = confusionMatrix(table(employeeData$Attrition, predict(model1, employeeData)))
